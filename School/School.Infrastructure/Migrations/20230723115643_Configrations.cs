...
{
    /// <inheritdoc />
    public partial class Configrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectNameAr = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    SubjectNameEn = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
